...
**When neither flag is set — the default — skip this entirely.** A default run tests the sheet as it stands and proposes uncovered cases at the end of the report, leaving the sheet untouched.
